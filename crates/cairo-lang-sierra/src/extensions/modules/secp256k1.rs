...
/// Libfunc for a secp256k1 elliptic curve negation system call.
#[derive(Default)]
pub struct Secp256K1EcNegLibfunc {}
impl SyscallGenericLibfunc for Secp256K1EcNegLibfunc {
    const STR_ID: &'static str = "secp256k1_ec_neg_syscall";
